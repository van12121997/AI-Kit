...
parser.add_argument('--mic', default=True, type=str, required=False, help='device name or number of input microphone')
parser.add_argument('--output', default='test.wav', type=str, required=False, help='path to output wav/ogg/flac file')
...
sample_count_end = args.sample_rate*10
sample_count = 0
